  ...
  return (
    <footer id="contact" className="py-14 sm:py-20 bg-slate-900 text-slate-300 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="p-6 sm:p-14 rounded-2xl sm:rounded-3xl bg-slate-800/90 border border-slate-700 shadow-2xl text-center space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 sm:gap-4 pt-2">
            ...
            <a
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-2.5 px-6 py-3.5 sm:px-7 sm:py-4 rounded-xl sm:rounded-2xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm transition-all shadow-lg shadow-blue-600/30 hover:-translate-y-1"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full sm:w-auto flex items-center justify-center gap-2.5 px-6 py-3.5 sm:px-7 sm:py-4 rounded-xl sm:rounded-2xl bg-slate-900 hover:bg-slate-950 text-white font-bold text-sm transition-all border border-slate-700 hover:-translate-y-1 shadow-md"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-2.5 px-6 py-3.5 sm:px-7 sm:py-4 rounded-xl sm:rounded-2xl bg-slate-900 border border-slate-700 hover:border-cyan-400 text-cyan-300 font-bold text-sm transition-all hover:-translate-y-1 shadow-md"
            >
        ...
        <div className="pt-8 sm:pt-12 flex items-center justify-center">
          <button
            onClick={scrollToTop}
            className="flex items-center gap-2 text-xs sm:text-sm font-bold text-slate-400 hover:text-cyan-400 transition-colors py-2 px-4 rounded-xl hover:bg-slate-800/50"
          >
