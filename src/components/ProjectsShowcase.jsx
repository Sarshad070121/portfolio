          ...
          {projectsData.map((project) => (
            ...
            >
              <div className="space-y-4 sm:space-y-5 text-left">
                ...
                {/* Project Summary */}
                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed font-normal text-left">
                  {project.summary}
                </p>
              ...
              <div className="pt-4 sm:pt-6 mt-4 sm:mt-6 border-t border-slate-200/80 flex flex-wrap items-center justify-between gap-2.5 sm:gap-3">
                <div className="flex flex-wrap gap-1.5 sm:gap-2">
                  {project.tags.map((tag, idx) => (
                    <span
                      key={idx}
                      className="px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-md text-[11px] sm:text-xs font-mono font-semibold bg-white text-slate-800 border border-slate-300 shadow-2xs"
                    >
                      {tag}
                    </span>
                  ))}
