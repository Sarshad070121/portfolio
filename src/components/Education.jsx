      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-5 sm:space-y-6 max-w-4xl mx-auto">
          {educationData.map((edu, index) => (
            <div
              key={index}
              className="p-5 sm:p-8 rounded-2xl sm:rounded-3xl bg-white border border-slate-200/80 shadow-sm hover:shadow-md transition-all space-y-3.5 sm:space-y-4 text-left"
            >
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2 sm:gap-4 border-b border-slate-100 pb-3.5 sm:pb-4">
                ...
                <div className="self-start flex items-center gap-1.5 text-xs font-mono font-bold text-slate-700 bg-slate-100 px-3 py-1 rounded-full">
